export const SESSION_STAT_DESCRIPTIONS: Record<string, string> = {
  ...
  'BURN RATE': 'Tokens consumed per minute, averaged over the last 5 minutes. Spikes during big file reads or long responses.',
  'TIME TO LIMIT': 'Estimated time until rate limit based on your personal history. More accurate after several limit hits.',
...
export const CONTEXT_STAT_DESCRIPTIONS: Record<string, string> = {
  'EST. CONTEXT USED': 'Estimated tokens filling Claude\'s context window for this session. Based on the most recent turn\'s input tokens.',
...
export const STATS_CARD_DESCRIPTIONS: Record<string, string> = {
  ...
  'AVG/DAY': 'Average tokens per active day. Days with no usage are excluded from this average.',
};
...
export const HISTORY_CARD_DESCRIPTIONS: Record<string, string> = {
  ...
  'AVG/DAY': 'Average daily token consumption on days you actually used Claude.',
};
